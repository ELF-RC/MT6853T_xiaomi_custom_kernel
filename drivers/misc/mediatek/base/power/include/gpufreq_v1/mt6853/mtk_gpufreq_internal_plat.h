...
struct opp_table_info g_opp_table_segment_1[] = {
	...
	GPUOP(906000, 76875, 76875, POSDIV_POWER_4, 1875), /* 1  */
	GPUOP(886000, 75625, 75625, POSDIV_POWER_4, 1875), /* 2  886MHz unlock */
	GPUOP(880000, 75000, 75000, POSDIV_POWER_4, 1875), /* 3  sign off */
	GPUOP(835000, 73125, 75000, POSDIV_POWER_4, 1875), /* 4  */
	GPUOP(790000, 71250, 75000, POSDIV_POWER_4, 1875), /* 5  */
	GPUOP(745000, 69375, 75000, POSDIV_POWER_4, 1250), /* 6  */
	GPUOP(700000, 67500, 75000, POSDIV_POWER_4, 1250), /* 7  */
	GPUOP(655000, 65625, 75000, POSDIV_POWER_4, 1250), /* 8  */
	GPUOP(640000, 65000, 75000, POSDIV_POWER_4, 1250), /* 9  sign off */
	GPUOP(598000, 63750, 75000, POSDIV_POWER_4, 1250), /* 10 */
	GPUOP(556000, 62500, 75000, POSDIV_POWER_4, 625),  /* 11 */
	GPUOP(494000, 60625, 75000, POSDIV_POWER_4, 625),  /* 12 */
	GPUOP(452000, 59375, 75000, POSDIV_POWER_4, 625),  /* 13 */
	GPUOP(410000, 58125, 75000, POSDIV_POWER_4, 625),  /* 14 */
	GPUOP(390000, 57500, 75000, POSDIV_POWER_4, 625),  /* 15 sign off */
};
...
struct opp_table_info g_opp_table_segment_2[] = {
	...
	GPUOP(655000, 65625, 75000, POSDIV_POWER_4, 1250), /* 8  */
	GPUOP(640000, 65000, 75000, POSDIV_POWER_4, 1250), /* 9  sign off */
	GPUOP(598000, 64375, 75000, POSDIV_POWER_4, 1250), /* 10 */
	GPUOP(556000, 63750, 75000, POSDIV_POWER_4, 625),  /* 11 */
	GPUOP(494000, 62500, 75000, POSDIV_POWER_4, 625),  /* 12 */
	GPUOP(452000, 61250, 75000, POSDIV_POWER_4, 625),  /* 13 */
	GPUOP(410000, 60625, 75000, POSDIV_POWER_4, 625),  /* 14 */
	GPUOP(390000, 60000, 75000, POSDIV_POWER_4, 625),  /* 15 sign off */
};
...
struct opp_table_info g_opp_table_segment_3[] = {
	...
	GPUOP(655000, 65625, 75000, POSDIV_POWER_4, 1250), /* 8  */
	GPUOP(640000, 65000, 75000, POSDIV_POWER_4, 1250), /* 9  sign off */
	GPUOP(598000, 65000, 75000, POSDIV_POWER_4, 1250), /* 10 */
	GPUOP(556000, 64375, 75000, POSDIV_POWER_4, 625),  /* 11 */
	GPUOP(494000, 63750, 75000, POSDIV_POWER_4, 625),  /* 12 */
	GPUOP(452000, 63125, 75000, POSDIV_POWER_4, 625),  /* 13 */
	GPUOP(410000, 63125, 75000, POSDIV_POWER_4, 625),  /* 14 */
	GPUOP(390000, 62500, 75000, POSDIV_POWER_4, 625),  /* 15 sign off */
};
