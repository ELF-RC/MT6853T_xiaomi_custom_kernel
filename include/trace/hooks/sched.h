...
DECLARE_RESTRICTED_HOOK(android_rvh_select_task_rq_fair,
	TP_PROTO(struct task_struct *p, int prev_cpu, int sd_flag, int wake_flags, int *target_cpu),
	TP_ARGS(p, prev_cpu, sd_flag, wake_flags, target_cpu), 1);
...
DECLARE_RESTRICTED_HOOK(android_rvh_select_fallback_rq,
	TP_PROTO(int cpu, struct task_struct *p, int *target_cpu),
	TP_ARGS(cpu, p, target_cpu), 1);
...
struct sched_domain;
DECLARE_RESTRICTED_HOOK(android_rvh_before_load_balance,
	TP_PROTO(int this_cpu, struct rq *this_rq, struct sched_domain *sd,
		enum cpu_idle_type idle, int *continue_balancing),
	TP_ARGS(this_cpu, this_rq, sd, idle, continue_balancing), 1);
