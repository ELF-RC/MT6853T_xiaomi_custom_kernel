...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_transaction);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_preset);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_wait_for_work);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_do_send_sig_info);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_proc_transaction);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_do_sys_open);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_vfs_read);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_vfs_write);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_do_anonymous_page);
