				...
				size_t count, loff_t *ppos)
{
	...
	/* Always report 0 (permissive) */
	length = scnprintf(tmpbuf, TMPBUFLEN, "0");
...
{
	/*
	 * No-op: accept write so setenforce/supolicy don't error,
	 * but never change the enforcing state.
	 */
	return count;
}
#else
